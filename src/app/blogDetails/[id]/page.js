  ...
  return (
    <div className={classes.blogDetails}>
      ...
      <div className={classes.header}>
        <h3>Technology</h3>
        <h1>Gucci Burst - A vintage video game inspired webGL experience</h1>
        <img
      ...
      <div className={classes.content}>
        ...
        <p>
          1914 translation by H. Rackham "But I must explain to you how all this mistaken idea of
      ...
      <div className={classes.commentContainer}>
        ...
        <div className={classes.comment}>
          ...
          <p className={classes.commentText}>
            You always give good advise. What would you say to someone?
          </p>
        </div>
      </div>
